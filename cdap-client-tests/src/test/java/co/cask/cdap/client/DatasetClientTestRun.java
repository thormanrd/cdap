...
public class DatasetClientTestRun extends ClientTestBase {
  ...
  public void testAll() throws Exception {
    ...
    datasetClient.update("testDataset", ImmutableMap.of("sdf", "foo"));
    DatasetMeta metaAfter = datasetClient.get("testDataset");
    Assert.assertEquals(1, metaAfter.getSpec().getProperties().size());
    Assert.assertTrue("foo", metaAfter.getSpec().getProperties().containsKey("sdf"));
